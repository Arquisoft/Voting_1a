package es.uniovi.asw.presentation.impl;
...
import es.uniovi.asw.presentation.BeanLoginMesa;

@ManagedBean(name = "loginMesa")
@RequestScoped
public class BeanLoginMesaImpl implements Serializable,BeanLoginMesa {
